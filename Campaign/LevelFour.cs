...
namespace PongGame
{
    public partial class LevelFour : Form
    {
        ...
        private int obstacle1X = 275;
        private int obstacle2X = 575;
        private int obstacleY = 0;
        private int obstacleHeight = SCREEN_HEIGHT;
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            // Draw obstacles
            e.Graphics.FillRectangle(Brushes.White, obstacle1X, obstacleY, obstacleWidth, obstacleHeight);
            e.Graphics.FillRectangle(Brushes.White, obstacle2X, obstacleY, obstacleWidth, obstacleHeight);
