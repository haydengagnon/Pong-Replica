...
namespace PongGame
{
    public partial class LevelTwo : Form
    {
        ...
        private int cpumove;
        private int obstacleX = 490;
        private int obstacleY = 225;
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            // Draw obstacles
            e.Graphics.FillRectangle(Brushes.Gray, obstacleX, obstacleY, obstacleWidth, obstacleHeight);
        ...
        private void GameTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (ballX + BALL_RADIUS > obstacleX && ballX - BALL_RADIUS < obstacleX + obstacleWidth && 
                ballY + BALL_RADIUS > obstacleY && ballY - BALL_RADIUS < obstacleY + obstacleHeight)
            {
                ballXVelocity = -ballXVelocity;
            }
            /*else if (ballX - BALL_RADIUS < obstacleX && ballY > obstacleY && ballY < obstacleY + obstacleHeight)
            {
                ballXVelocity = -ballXVelocity;
            }*/
